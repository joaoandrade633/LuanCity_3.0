# aumento da velocidade dos obstaculos
import pygame
...
while True: #while para atualizar atualizar o janela e não fechar.
    for event in pygame.event.get():
        ...
        if event.type == obstaculo_cronometro and jogo_ativo:
            if randint(0,2):
                if pontuacao >= 0 and pontuacao < 30:
                    obstaculo_retangulo_lista.append(obstaculo_imagem.get_rect(bottomright = (randint(1000, 1400), 409))) #lista dos obstáculos
                elif pontuacao >= 30 and pontuacao < 60:
                    obstaculo_retangulo_lista.append(obstaculo_imagem.get_rect(bottomright = (randint(1000, 1200), 409))) #lista dos obstáculos
                elif pontuacao >= 60 and pontuacao < 90:
                    obstaculo_retangulo_lista.append(obstaculo_imagem.get_rect(bottomright = (randint(1000, 1100), 409))) #lista dos obstáculos
                else:
                    obstaculo_retangulo_lista.append(obstaculo_imagem.get_rect(bottomright = (randint(1000, 1050), 409))) #lista dos obstáculos
            else:
                if pontuacao >= 0 and pontuacao < 30:
                    obstaculo_retangulo_lista.append(obstaculo_imagem_2.get_rect(bottomright = (randint(1000, 1400), 408))) #lista dos obstáculos 2
                elif pontuacao >= 30 and pontuacao < 60:
                    obstaculo_retangulo_lista.append(obstaculo_imagem_2.get_rect(bottomright = (randint(1000, 1200), 408))) #lista dos obstáculos 2
                elif pontuacao >= 60 and pontuacao < 90:
                    obstaculo_retangulo_lista.append(obstaculo_imagem_2.get_rect(bottomright = (randint(1000, 1100), 408))) #lista dos obstáculos 2
                else:
                    obstaculo_retangulo_lista.append(obstaculo_imagem_2.get_rect(bottomright = (randint(1000, 1050), 408))) #lista dos obstáculos 2
