# Movimentação do personagem (pulo e gravidade)
...
obstaculo_retangulo = obstaculo_imagem.get_rect(bottomright = (900, 430)) #cria retangulo e centraliza no 
...
while True: #while para atualizar atualizar o janela e não fechar.
    ...
    # Obstáculo
    obstaculo_retangulo.x -= 7 #movimenta o obstaculo
